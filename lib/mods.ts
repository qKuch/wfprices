...
export const MODS: Mod[] = [
  ...
  // ── Archon ────────────────────────────────────────────────
  { name: 'Archon Continuity',        slug: 'archon_continuity',        category: 'Archon',    maxRank: 10, rarity: 'Legendary' },
  { name: 'Archon Intensify',         slug: 'archon_intensify',         category: 'Archon',    maxRank: 10, rarity: 'Legendary' },
  { name: 'Archon Stretch',           slug: 'archon_stretch',           category: 'Archon',    maxRank: 10, rarity: 'Legendary' },
  { name: 'Archon Vitality',          slug: 'archon_vitality',          category: 'Archon',    maxRank: 10, rarity: 'Legendary' },
  { name: 'Archon Flow',              slug: 'archon_flow',              category: 'Archon',    maxRank: 10, rarity: 'Legendary' },
]
